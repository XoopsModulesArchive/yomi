...
$modversion['sub'][1]['name'] = _MI_YOMI_NEW;
$modversion['sub'][1]['url'] = '?mode=new';
$modversion['sub'][2]['name'] = _MI_YOMI_RENEW;
$modversion['sub'][2]['url'] = '?mode=renew';
$modversion['sub'][3]['name'] = _MI_YOMI_RANK;
$modversion['sub'][3]['url'] = 'rank.php';
$modversion['sub'][4]['name'] = _MI_YOMI_MAP;
$modversion['sub'][4]['url'] = 'sitemap.php';
$modversion['sub'][5]['name'] = _MI_YOMI_HELP;
$modversion['sub'][5]['url'] = 'regist_ys.php?mode=help';
