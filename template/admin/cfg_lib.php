...
fwrite($fp, $PR_search_form);
fwrite($fp, "} #end of &search_form\n");
##sub menu_barを更新
$out = <<<EOM
##メニューバーの設定
function menu_bar(){
...
fwrite($fp, $out);
#ここに書く($PR_menu_bar)
fwrite($fp, $PR_menu_bar);
fwrite($fp, "} #end of &menu_bar\n");
##sub head_spを更新
$out = <<<EOM
##メニューバーの設定
function head_sp(){
...
fwrite($fp, $out);
#ここに書く($PR_head_sp)
fwrite($fp, $PR_head_sp);
fwrite($fp, "} #end of &head_sp\n");
##sub foot_spを更新
$out = <<<EOM
##メニューバーの設定
function foot_sp(){
...
fwrite($fp, $out);
#ここに書く($PR_foot_sp)
fwrite($fp, $PR_foot_sp);
fwrite($fp, "} #end of &foot_sp\n");
fwrite($fp, '?>');
fclose($fp);
